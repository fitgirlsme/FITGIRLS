    ...
    PORTRAIT: [
        {
            ...
            details: [
                '컨셉당 의상 1벌, 배경 2가지',
                '모든 컨셉 핏걸즈 의상 활용 가능',
                '보정 2장 · 4x6 프린트 1장 · 웹용 원본파일 제공 · 30분 촬영'
            ]
        },
        {
            id: 2,
            ...
            details: [
                ...
                '모든 컨셉 핏걸즈 의상 활용 가능',
                '보정 4장 · 4x6 프린트 2장 · 웹용 원본파일 제공 · 90분 촬영'
            ]
        },
        {
            id: 3,
            ...
            details: [
                '의상 · 배경 · 포즈 모두 무제한 활용',
                '모든 컨셉 핏걸즈 의상 활용 가능',
                '보정 6장 · 4x6 프린트 3장 · 웹용 원본파일 제공 · 120분 촬영'
            ]
        }
    ],
    FRIENDS: [
        ...
        <section id="service" className="snap-section service-container">
            <div className="container-inner">
                ...
                <div className="service-notice">
                    <ul>
                        <li>재방문 예약 시 2회 20%, 3회 이상 30% 할인 혜택 (2컨셉 이상 예약 시 적용, 카카오채널 문의)</li>
                        <li>예약제 스튜디오 · 모든 금액은 VAT 포함</li>
                        <li><strong>핏걸즈 스튜디오는 평일&주말 가격이 모두 동일합니다.</strong></li>
                        <li>보정기간 : 셀렉 당일 1장 당일 보정, \n나머지 사진은 2~3주 이내 완료</li>
